# 調代課申請模組 `jill_leave` 使用手冊

本模組專為學校設計，旨在提供教學組與相關管理人員掌握調代課申請的調代課資訊，並能快速生成鐘點費清冊與 PDF 假單，減少行政作業流程。
...
1. **線上填報**：登入調代課申請模組，於線上填報「調代課申請」表單，設定代課與課務資訊。
...
### 4.2 檢視請假記錄
- 教師進入「調代課申請主頁」即可看到個人的請假歷史清單、請假起訖時間、代課節數，以及「審核狀態」：
