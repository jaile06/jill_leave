...
<div class="text-center">
    <{if $smarty.session.jill_leave_adm|default:false}>
        <a href="javascript:jill_leave_cate_destroy_func(<{$cate_sn}>);" class="btn btn-sm btn-danger" aria-label="<{$smarty.const._TAD_DEL}>" data-bs-toggle="tooltip" title="<{$smarty.const._TAD_DEL}>"><i class="fa fa-times" aria-hidden="true"></i></a>
